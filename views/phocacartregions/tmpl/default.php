...
echo '<th class="ph-code">'.JHTML::_('grid.sort',  	$this->t['l'].'_CODE', 'a.code3', $listDirn, $listOrder ).'</th>'."\n";	
...
echo $r->td($item->country_title, "small hidden-phone");
echo $r->td($item->code3, "small hidden-phone");
