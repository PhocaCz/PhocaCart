...
class PhocaCartCpViewPhocaCartTaxes extends JViewLegacy
{
	...
	function addToolbar() {
		...
		JToolBarHelper::title( JText::_( $this->t['l'].'_TAXES' ), 'calendar' );
		...
		if ($canDo->get('core.delete')) {
			JToolBarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacarttaxes.delete', $this->t['l'].'_DELETE');
		}
		JToolBarHelper::divider();
	...
	protected function getSortFields() {
		return array(
			...
			'a.tax_rate' 		=> JText::_($this->t['l'] . '_TAX_RATE'),
			'a.calculation_type' => JText::_($this->t['l'] . '_CALCULATION_TYPE'),
