...
echo '<th class="ph-movements ph-center">'.JHTML::_('grid.sort',  $this->t['l'].'_STOCK_MOVEMENTS', 'a.stock_movements', $listDirn, $listOrder ).'</th>'."\n";	
echo '<th class="ph-download ph-center">'.JHTML::_('grid.sort',  $this->t['l'].'_DOWNLOAD', 'a.download', $listDirn, $listOrder ).'</th>'."\n";
echo '<th class="ph-type ph-center">'.JHTML::_('grid.sort',  $this->t['l'].'_DEFAULT', 'a.type', $listDirn, $listOrder ).'</th>'."\n";	
echo '<th class="ph-id ph-center">'.JHTML::_('grid.sort',  		$this->t['l'].'_ID', 'a.id', $listDirn, $listOrder ).'</th>'."\n";
