...
class PhocaCartCpViewPhocacartGroup extends JViewLegacy
{
	...
	public function display($tpl = null) {
		...
		if (isset($this->item->type) && (int)$this->item->type ==  1) {
			$this->form->setFieldAttribute( 'minimum_sum', 'readonly', 'true' );
	...
	protected function addToolbar() {
		...
		JToolbarHelper::title(   JText::_( $this->t['l'] . '_CUSTOMER_GROUP' ).': <small><small>[ ' . $text.' ]</small></small>' , 'credit-card');
