...
class PhocaCartCpViewPhocacartSections extends JViewLegacy
{
	...
	function addToolbar() {
		...
		JToolbarHelper::title( JText::_( $this->t['l'].'_SECTIONS' ), 'unchecked' );
		...
		if ($canDo->get('core.delete')) {
			JToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartsections.delete', $this->t['l'].'_DELETE');
		}
		JToolbarHelper::divider();
