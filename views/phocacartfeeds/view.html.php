...
class PhocaCartCpViewPhocacartFeeds extends JViewLegacy
{
	...
	function addToolbar() {
		...
		JToolbarHelper::title( JText::_( $this->t['l'].'_XML_FEEDS' ), 'bullhorn' );
		...
		if ($canDo->get('core.delete')) {
			JToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartfeeds.delete', $this->t['l'].'_DELETE');
		}
		JToolbarHelper::divider();
