...
class PhocaCartCpViewPhocaCartCurrencies extends JViewLegacy
{
	...
	function display($tpl = null) {
		...
		$this->t['default_currency']	= PhocacartCurrency::getDefaultCurrencyArray();
	...
	function addToolbar() {
		...
		JToolbarHelper::title( JText::_( $this->t['l'].'_CURRENCIES' ), 'eur' );
		...
		if ($canDo->get('core.delete')) {
			JToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartcurrencies.delete', $this->t['l'].'_DELETE');
		}
		JToolbarHelper::divider();
	...
	protected function getSortFields() {
		return array(
			...
			'a.price_currency_symbol' => JText::_($this->t['l'] . '_CURRENCY_SYMBOL'),
			'a.exchange_rate' 	=> JText::_($this->t['l'] . '_EXCHANGE_RATE'),
