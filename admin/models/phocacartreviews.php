...
class PhocaCartCpModelPhocacartReviews extends ListModel
{
...
/*		$accessId = $app->getUserStateFromRequest($this->context.'.filter.access', 'filter_access', null, 'int');
	...
	protected function getListQuery() {
		...
		$query->select('ua.id AS reviewuserid, ua.username AS reviewusername, ua.name AS reviewname');
...
/*		if ($access = $this->getState('filter.access')) {
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.name LIKE '.$search.' OR a.review LIKE '.$search.')');
			}
		}
