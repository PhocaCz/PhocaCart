...
class JFormFieldPhocacartShippingParamsPayment extends FormField
{
	protected $type 		= 'PhocacartShippingParamsPayment';
	...
	protected function getInput() {
		...
		if ($id > 0) {
			...
			$activeMethods = $params->get('payment_zero', array());

		}

		$payments 			= PhocacartPayment::getAllPaymentMethods();
		$data               = $this->getLayoutData();
		$data['options']    = (array)$payments;
