...
echo '<th class="ph-method">' . HTMLHelper::_('searchtools.sort', $this->t['l'] . '_SHIPPING_METHOD', 'a.method', $listDirn, $listOrder) . '</th>' . "\n";
...
if (is_array($this->items)) {
    foreach ($this->items as $i => $item) {
        ...
        if ($item->active_quantity) {
            $rules[] = '<span class="label label-default label-default">' . Text::_('COM_PHOCACART_QUANTITY_RULE') . '</span>';
        }
        ...
        if ($item->active_zip) {
            $rules[] = '<span class="label label-success badge bg-success label-success">' . Text::_('COM_PHOCACART_ZIP_RULE') . '</span>';
        }
        ...
        if ($item->active_weight) {
            $rules[] = '<span class="label label-success badge bg-success label-success">' . Text::_('COM_PHOCACART_WEIGHT_RULE') . '</span>';
        }
        if ($item->active_size) {
            $rules[] = '<span class="label label-primary label-primary">' . Text::_('COM_PHOCACART_SIZE_RULE') . '</span>';
        }
