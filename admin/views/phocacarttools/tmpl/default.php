...
$url 	= Route::_('index.php?option=com_phocacart&view=phocacarttools');
$c1 	= $c2 = 'circle';
$msg	= '';

$tabs                   = array();
$tabs['bpuv']        = Text::_('COM_PHOCACART_BULK_PRICE_UPDATE_VALUE');
$tabs['bpuk']          = Text::_('COM_PHOCACART_BULK_PRICE_UPDATE_KEY');
...
echo '<label for="file_import">'. Text::_('COM_PHOCACART_EXPORT').':</label>';
echo '<input class="btn btn-primary" type="submit"  name="submit" value="'. Text::_('COM_PHOCACART_EXPORT').'">';
echo '</div>';
echo '</form>';
	...
	<div class="row import-export-row">
		<div class="col-xs-12 col-sm-6 col-md-6">
			...
			<?php if ((int)$this->t['count'] > 0) { ?>
					...
					<h2><?php echo Text::_('COM_PHOCACART_TOOLS'); ?></h2>
