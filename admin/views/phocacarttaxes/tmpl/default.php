...
echo '<th class="ph-taxrate">'.JHtml::_('grid.sort',  $this->t['l'].'_TAX_RATE', 'a.tax_rate', $listDirn, $listOrder ).'</th>'."\n";	
echo '<th class="ph-type">'.JHtml::_('grid.sort',  $this->t['l'].'_CALCULATION_TYPE', 'a.calculation_type', $listDirn, $listOrder ).'</th>'."\n";	
