...
class PhocaCartCpViewPhocacartTaxes extends HtmlView
{
	protected $items;
	...
	function addToolbar() {
		...
		ToolbarHelper::title( Text::_( $this->t['l'].'_TAXES' ), 'calendar' );
		...
		if ($canDo->get('core.delete')) {
			ToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacarttaxes.delete', $this->t['l'].'_DELETE');
		}
		ToolbarHelper::divider();
	...
	protected function getSortFields() {
		return array(
			...
			'a.tax_rate' 		=> Text::_($this->t['l'] . '_TAX_RATE'),
			'a.calculation_type' => Text::_($this->t['l'] . '_CALCULATION_TYPE'),
