...
class PhocaCartCpViewPhocacartRegion extends HtmlView
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar() {
		...
		$canDo		= $class::getActions($this->t, $this->state->get('filter.region_id'));

		$text = $isNew ? Text::_( $this->t['l'] . '_NEW' ) : Text::_($this->t['l'] . '_EDIT');
		ToolbarHelper::title(   Text::_( $this->t['l'] . '_REGION' ).': <small><small>[ ' . $text.' ]</small></small>' , 'globe');
