...
class PhocaCartCpViewPhocacartDiscounts extends HtmlView
{
	protected $items;
	...
	function addToolbar() {
		...
		$canDo	= $class::getActions($this->t, $state->get('filter.discount_id'));

		ToolbarHelper::title( Text::_( $this->t['l'].'_DISCOUNTS' ), 'piggy-bank' );
		...
		if ($canDo->get('core.delete')) {
			ToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartdiscounts.delete', $this->t['l'].'_DELETE');
		}
		ToolbarHelper::divider();
