...
class PhocaCartCpViewPhocacartDiscounts extends JViewLegacy
{
	...
	function addToolbar() {
		...
		JToolbarHelper::title( JText::_( $this->t['l'].'_DISCOUNTS' ), 'piggy-bank' );
		...
		if ($canDo->get('core.delete')) {
			JToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartdiscounts.delete', $this->t['l'].'_DELETE');
		}
		JToolbarHelper::divider();
