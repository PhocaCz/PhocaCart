...
echo '<th class="ph-title">'.Joomla\CMS\HTML\HTMLHelper::_('searchtools.sort',  	$this->t['l'].'_PARAMETER', 'a.parameter_id', $listDirn, $listOrder ).'</th>'."\n";
...
$paramO = '';
if ($canCreate || $canEdit) {
	$paramO .= '<a href="'. JRoute::_($linkEditP).'">'. $this->escape($item->parameter_title).'</a>';
} else {
