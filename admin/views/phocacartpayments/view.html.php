...
class PhocaCartCpViewPhocacartPayments extends JViewLegacy
{
	...
	function addToolbar() {
		...
		JToolbarHelper::title( JText::_( $this->t['l'].'_PAYMENT_METHODS' ), 'credit-card' );
		...
		if ($canDo->get('core.delete')) {
			JToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartpayments.delete', $this->t['l'].'_DELETE');
		}
	...
	protected function getSortFields() {
		return array(
			...
			'a.method' 			=> JText::_($this->t['l'] . '_METHOD'),
            'a.cost' 			=> JText::_($this->t['l'] . '_PRICE'),
