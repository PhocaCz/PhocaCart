...
echo '<th class="ph-title">'.JHtml::_('grid.sort',  	$this->t['l'].'_DAY', 'a.day', $listDirn, $listOrder ).'</th>'."\n";
echo '<th class="ph-title">'.JHtml::_('grid.sort',  	$this->t['l'].'_DATE', 'a.date', $listDirn, $listOrder ).'</th>'."\n";
