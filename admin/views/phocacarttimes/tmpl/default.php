...
echo '<th class="ph-title">'.Joomla\CMS\HTML\HTMLHelper::_('searchtools.sort',  	$this->t['l'].'_TYPE', 'a.type', $listDirn, $listOrder ).'</th>'."\n";
echo '<th class="ph-title">'.Joomla\CMS\HTML\HTMLHelper::_('searchtools.sort',  	$this->t['l'].'_DAY', 'a.day', $listDirn, $listOrder ).'</th>'."\n";
echo '<th class="ph-title">'.Joomla\CMS\HTML\HTMLHelper::_('searchtools.sort',  	$this->t['l'].'_DATE', 'a.date', $listDirn, $listOrder ).'</th>'."\n";
echo '<th class="ph-title">'.JText::_($this->t['l'].'_TIME_FROM').'</th>'."\n";
echo '<th class="ph-title">'.JText::_($this->t['l'].'_TIME_TO').'</th>'."\n";
...
$timeFrom = PhocaCartTime::getTime($item->hour_from, $item->minute_from, $item->type);
$timeTo = PhocaCartTime::getTime($item->hour_to, $item->minute_to, $item->type);
