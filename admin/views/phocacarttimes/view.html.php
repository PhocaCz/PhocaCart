...
class PhocaCartCpViewPhocacartTimes extends JViewLegacy
{
	...
	function addToolbar() {
		...
		JToolbarHelper::title( JText::_( $this->t['l'].'_OPENING_TIMES' ), 'time' );
		...
		if ($canDo->get('core.delete')) {
			JToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacarttimes.delete', $this->t['l'].'_DELETE');
		}
		JToolbarHelper::divider();
