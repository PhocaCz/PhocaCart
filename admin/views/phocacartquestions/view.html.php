...
class PhocaCartCpViewPhocaCartQuestions extends HtmlView
{
	protected $items;
	...
	function addToolbar() {
		...
		ToolbarHelper::title( Text::_( $this->t['l'].'_QUESTIONS' ), 'question-sign' );
	...
	protected function getSortFields() {
		return array(
			...
			'a.phone' 			=> Text::_($this->t['l'] . '_PHONE'),
			'a.ip'	 			=> Text::_($this->t['l'] . '_IP'),
			'a.message' 		=> Text::_($this->t['l'] . '_MESSAGE'),
