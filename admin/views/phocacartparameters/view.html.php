...
class PhocaCartCpViewPhocacartParameters extends HtmlView
{
	protected $items;
	...
	function addToolbar() {
		...
		if ($canDo->get('core.delete')) {
			ToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartparameters.delete', $this->t['l'].'_DELETE');
		}
		ToolbarHelper::divider();
