...
class PhocaCartCpViewPhocaCartCurrencies extends HtmlView
{
	protected $items;
	...
	protected function getSortFields() {
		return array(
			...
			'a.price_currency_symbol' => Text::_($this->t['l'] . '_CURRENCY_SYMBOL'),
			'a.exchange_rate' 	=> Text::_($this->t['l'] . '_EXCHANGE_RATE'),
