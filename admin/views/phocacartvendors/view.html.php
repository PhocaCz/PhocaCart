...
class PhocaCartCpViewPhocacartVendors extends HtmlView
{
    protected $items;
    ...
    function addToolbar() {
        ...
        $canDo = $class::getActions($this->t, $state->get('filter.vendor_id'));

        ToolbarHelper::title(Text::_($this->t['l'] . '_VENDORS'), 'users');
        ...
        if ($canDo->get('core.delete')) {
            ToolbarHelper::deleteList($this->t['l'] . '_WARNING_DELETE_ITEMS', 'phocacartvendors.delete', $this->t['l'] . '_DELETE');
        }
        ToolbarHelper::divider();
