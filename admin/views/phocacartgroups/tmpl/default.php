...
echo '<th class="ph-min-purchase">' . Joomla\CMS\HTML\HTMLHelper::_('searchtools.sort', $this->t['l'] . '_MINIMAL_SUM_OF_PURCHASES', 'a.minimum_sum', $listDirn, $listOrder) . '</th>' . "\n";
echo '<th class="ph-default">' . Joomla\CMS\HTML\HTMLHelper::_('searchtools.sort', $this->t['l'] . '_DEFAULT', 'a.type', $listDirn, $listOrder) . '</th>' . "\n";
