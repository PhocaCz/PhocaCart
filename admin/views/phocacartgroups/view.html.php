...
class PhocaCartCpViewPhocacartGroups extends HtmlView
{
	protected $items;
	...
	function addToolbar() {
		...
		$canDo	= $class::getActions($this->t, $state->get('filter.group_id'));

		ToolbarHelper::title( Text::_( $this->t['l'].'_CUSTOMER_GROUPS' ), 'groups' );
		...
		if ($canDo->get('core.delete')) {
			ToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartgroups.delete', $this->t['l'].'_DELETE');
		}
		ToolbarHelper::divider();
