...
class PhocaCartCpViewPhocacartUnits extends HtmlView
{
	protected $items;
	...
	function addToolbar() {
		...
		ToolbarHelper::title( Text::_( $this->t['l'].'_UNITS' ), 'modal-window' );
		...
		if ($canDo->get('core.delete')) {
			ToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocacartunits.delete', $this->t['l'].'_DELETE');
		}
		ToolbarHelper::divider();
	...
	protected function getSortFields() {
		return array(
			...
			'section_title' 	=> Text::_($this->t['l'] . '_SECTION'),
