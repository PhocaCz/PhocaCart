...
class PhocaCartCpViewPhocacartTax extends HtmlView
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar() {
		...
		$canDo		= $class::getActions($this->t, $this->state->get('filter.tax_id'));

		$text = $isNew ? Text::_( $this->t['l'] . '_NEW' ) : Text::_($this->t['l'] . '_EDIT');
		ToolbarHelper::title(   Text::_( $this->t['l'] . '_TAX' ).': <small><small>[ ' . $text.' ]</small></small>' , 'calendar');
