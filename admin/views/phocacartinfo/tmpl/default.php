...
echo '<div style="float:right;margin:10px;">' . Joomla\CMS\HTML\HTMLHelper::_('image', $this->t['i'] . 'logo-phoca.png', 'Phoca.cz') . '</div>'
    . '<div class="ph-cpanel-logo-info">' . Joomla\CMS\HTML\HTMLHelper::_('image', $this->t['i'] . 'logo-' . str_replace('phoca', 'phoca-', $this->t['c']) . '.png', 'Phoca.cz') . '</div>'
...
echo '<div style="float:right;margin:10px;">'
    . Joomla\CMS\HTML\HTMLHelper::_('image', $this->t['i'] . 'logo-phoca.png', 'Phoca.cz')
    . '</div>'
    . Joomla\CMS\HTML\HTMLHelper::_('image', $this->t['i'] . 'logo-phoca-cart.png', 'Phoca.cz')
    . '<div style="clear:both;"></div>'
...
echo '<br />' . Joomla\CMS\HTML\HTMLHelper::_('image', $this->t['i'] . 'logo.png', 'Phoca.cz') . '<br />';
