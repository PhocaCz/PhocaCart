...
class PhocaCartCpViewPhocacartReview extends HtmlView
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar() {
		...
		$canDo		= $class::getActions($this->t, $this->state->get('filter.review_id'));

		$text = $isNew ? Text::_( $this->t['l'] . '_NEW' ) : Text::_($this->t['l'] . '_EDIT');
		ToolbarHelper::title(   Text::_( $this->t['l'] . '_REVIEW' ).': <small><small>[ ' . $text.' ]</small></small>' , 'comment');
