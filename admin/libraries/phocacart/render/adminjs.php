...
final class PhocacartRenderAdminjs
{
	...
	*/
	...
	public static function renderAjaxDoRequestWizard() {
		...
		$s[] = '   var dataPost = {};';
		$s[] = '   var phTrue   = \'<div class="ph-true"><span class="'.PhocacartRenderIcon::getClassAdmin('ok').' icon-ok"></span> '.JText::_('COM_PHOCACART_CREATED').'</div>\';';
		$s[] = '   var phTrueAdd   = \'<div class="ph-true"><span class="'.PhocacartRenderIcon::getClassAdmin('ok').' icon-ok"></span> '.JText::_('COM_PHOCACART_ADDED').'</div>\';';
		$s[] = '   var phTrueEdit   = \'<div class="ph-true"><span class="'.PhocacartRenderIcon::getClassAdmin('ok').' icon-ok"></span> '.JText::_('COM_PHOCACART_EDITED').'</div>\';';
		$s[] = '   var phTrueAll = 1';
		$s[] = '   var phFalse  = \'<div class="ph-false"><span class="'.PhocacartRenderIcon::getClassAdmin('remove').' icon-remove"></span> '.JText::_('COM_PHOCACART_NOT_CREATED_YET').'</div>\';';
		$s[] = '   var phFalseAdd  = \'<div class="ph-false"><span class="'.PhocacartRenderIcon::getClassAdmin('remove').' icon-remove"></span> '.JText::_('COM_PHOCACART_NOT_ADDED_YET').'</div>\';';
		$s[] = '   var phFalseEdit  = \'<div class="ph-false"><span class="'.PhocacartRenderIcon::getClassAdmin('remove').' icon-remove"></span> '.JText::_('COM_PHOCACART_NOT_EDITED_YET').'</div>\';';
		$s[] = '   phRequestActive = jQuery.ajax({';
		$s[] = '      url: url,';
		$s[] = '      type:\'POST\',';
		$s[] = '      data:dataPost,';
