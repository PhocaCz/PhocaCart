...
class PhocacartRenderStyle
{
    ...
    public static function getStyles() {
        ...
        if (empty(self::$styles)) {
            ...
            if ($pos) {
                $theme = 'svg';
                $icons = 'svg';// only icons are now active for admin
            } else if ($admin) {
                $theme = 'bs5';
    ...
    public static function loadStyles($theme, $icons, $params = []) {
        ...
        switch ($icons) {
            ...
            case 'svg':
                ...
                $s['i']['view-category']   = $pf . 'view-category' . $sf;
                $s['i']['view-product']    = $pf . 'view-product' . $sf;
                $s['i']['back-category']   = $pf . 'back-category' . $sf;
                $s['i']['ok']              = $pf . 'ok' . $sf;
                $s['i']['ok-strong']       = $pf . 'ok-strong' . $sf;
                $s['i']['not-ok']          = $pf . 'not-ok' . $sf;
                $s['i']['remove']          = $pf . 'remove' . $sf;
                $s['i']['clear']           = $pf . 'clear' . $sf;
                $s['i']['remove-circle']   = $pf . 'remove-circle' . $sf;
                $s['i']['edit']            = $pf . 'edit' . $sf;
                $s['i']['plus']            = $pf . 'plus' . $sf;
                $s['i']['minus']           = $pf . 'minus' . $sf;
                $s['i']['chevron-up']      = $pf . 'chevron-up' . $sf;
                ...
                $s['i']['question-sign']   = $pf . 'question-sign' . $sf;
                $s['i']['info-sign']       = $pf . 'info-sign' . $sf;
                $s['i']['compare']         = $pf . 'compare' . $sf;
                $s['i']['ext-link']        = $pf . 'ext-link' . $sf;
                $s['i']['int-link']        = $pf . 'int-link' . $sf;
                $s['i']['download']        = $pf . 'download' . $sf;
                ...
                $s['i']['user']            = $pf . 'user' . $sf;
                $s['i']['grid']            = $pf . 'grid' . $sf;
                $s['i']['gridlist']        = $pf . 'gridlist' . $sf;
                $s['i']['list']            = $pf . 'list' . $sf;
                $s['i']['next']            = $pf . 'next' . $sf;
                $s['i']['prev']            = $pf . 'prev' . $sf;
                $s['i']['submit']          = $pf . 'submit' . $sf;
                $s['i']['list-alt']        = $pf . 'list-alt' . $sf;
                $s['i']['invoice']         = $pf . 'invoice' . $sf;
                $s['i']['del-note']        = $pf . 'del-note' . $sf;
                $s['i']['order']           = $pf . 'order' . $sf;
                $s['i']['receipt']         = $pf . 'receipt' . $sf;
                $s['i']['print']           = $pf . 'print' . $sf;
                $s['i']['barcode']         = $pf . 'barcode' . $sf;
                $s['i']['search']          = $pf . 'search' . $sf;
                $s['i']['payment-method']  = $pf . 'payment-method' . $sf;
                $s['i']['shipping-method'] = $pf . 'shipping-method' . $sf;
                $s['i']['log-out']         = $pf . 'log-out' . $sf;
                $s['i']['calendar']        = $pf . 'calendar' . $sf;
                $s['i']['globe']           = $pf . 'globe' . $sf;
                $s['i']['upload']          = $pf . 'upload' . $sf;
                $s['i']['filter']          = $pf . 'filter' . $sf;
