...
class PhocacartOrderView
{
	...
	public function getItemCommon($orderId) {
		...
		$query = 'SELECT o.*,'
				...
				.' c.title AS coupontitle, cu.title AS currencytitle, cu.price_currency_symbol AS currency_symbol, cu.bank_account_number AS currency_bank_account_number,'
			    .' cu.iban AS currency_iban, cu.bic_swift AS currency_bic_swift, cu.pdf_invoice_qr_information AS currency_pdf_invoice_qr_information, cu.pdf_invoice_qr_code AS currency_pdf_invoice_qr_code,'
				.' d.title AS discounttitle, os.orders_view_display as ordersviewdisplay,'
