...
class PhocacartOrderStatus
{
	...
	public static function getEmailSendSelectBox($value) {
		...
		return Joomla\CMS\HTML\HTMLHelper::_('select.genericlist',  $data,  'jform[email_send]', 'class="form-select"', 'value', 'text', $value, $data[$value] );
	}
...
/*
	public static function getEmailSendGiftSelectBox($value) {
		...
		return Joomla\CMS\HTML\HTMLHelper::_('select.genericlist',  $data,  'jform[email_gift]', 'class="form-control"', 'value', 'text', $value, $data[$value] );
...
*/
	public static function getEmailSendFormatSelectBox($value) {
		...
		return Joomla\CMS\HTML\HTMLHelper::_('select.genericlist',  $data,  'jform[email_send_format]', 'class="form-select"', 'value', 'text', $value, $data[$value] );
	}
	...
	public static function getStockMovementsSelectBox($value) {
		...
		return Joomla\CMS\HTML\HTMLHelper::_('select.genericlist',  $data,  'jform[stock_movements]', 'class="form-select"', 'value', 'text', $value, $data[$value] );
	}
	...
	public static function getChangeUserGroupSelectBox($value) {
		...
		return Joomla\CMS\HTML\HTMLHelper::_('select.genericlist',  $data,  'jform[change_user_group]', 'class="form-select"', 'value', 'text', $value, $data[$value] );
	}
	...
	public static function getChangeChangePointsNeededSelectBox($value) {
		...
		return Joomla\CMS\HTML\HTMLHelper::_('select.genericlist',  $data,  'jform[change_points_needed]', 'class="form-select"', 'value', 'text', $value, $data[$value] );
	}
	...
	public static function getChangePointsReceivedSelectBox($value) {
		...
		return Joomla\CMS\HTML\HTMLHelper::_('select.genericlist',  $data,  'jform[change_points_received]', 'class="form-select"', 'value', 'text', $value, $data[$value] );
	}
