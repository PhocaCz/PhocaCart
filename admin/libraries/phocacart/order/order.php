...
class PhocacartOrder
{
    ...
    public static function storeOrderReceiptInvoiceId($id, $date, $statusId, $docs = array()) {
        ...
        if (!isset($d['order_number_id'])) {$d['order_number_id'] = 0;}
        if (!isset($d['receipt_number_id'])) {$d['receipt_number_id'] = 0;}
        if (!isset($d['invoice_number_id'])) {$d['invoice_number_id'] = 0;}
        if (!isset($d['order_number'])) {$d['order_number'] = '';}
        if (!isset($d['receipt_number'])) {$d['receipt_number'] = '';}
        if (!isset($d['invoice_number'])) {$d['invoice_number_id'] = '';}
        return $d;
    }
