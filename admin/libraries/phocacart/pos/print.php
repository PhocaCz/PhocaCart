			...
			switch($pos_print_connector) {
				...
				case "2":
					...
					if ($pos_print_connector_ip != '') {
						...
						PhocacartLog::add(1, 'Printer Settings Error: No IP set');
						return false;
					}
				break;
				...
				case "3":
					if ($pos_print_connector_dest != '') {
						...
						PhocacartLog::add(1, 'Printer Settings Error: No Destination set');
						return false;
					}
				break;
				...
				default:
					...
					if ($pos_print_connector_file != '') {
						...
						PhocacartLog::add(1, 'Printer Settings Error: No File set');
						return false;
					}
				break;
	...
	public function printOrder($o) {
		...
		if (!empty($oA)) {
			...
			if ($this->connector instanceof Mike42\Escpos\PrintConnectors\PrintConnector) {
				...
				PhocacartLog::add(1, 'Server Printer Not Set - see POS Print Settings');
				ob_get_clean();
			}
			
			} catch ( Exception $e ) {
				
				PhocacartLog::add(1, 'Server Printer Error: '.$e->getMessage());
				ob_get_clean();
			}
		}
