...
ALTER TABLE `#__phocacart_products` ADD COLUMN `type_feed` text NOT NULL DEFAULT '';
ALTER TABLE `#__phocacart_products` ADD COLUMN `type_category_feed` text NOT NULL DEFAULT '';

ALTER TABLE `#__phocacart_categories` ADD COLUMN `type_feed` text NOT NULL DEFAULT '';
