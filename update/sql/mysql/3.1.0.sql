...
ALTER TABLE `#__phocacart_orders` ADD COLUMN `reference_data` text NOT NULL;
...
ALTER TABLE `#__phocacart_orders` ADD COLUMN `invoice_spec_top_desc` text NOT NULL;
ALTER TABLE `#__phocacart_orders` ADD COLUMN `invoice_spec_middle_desc` text NOT NULL;
ALTER TABLE `#__phocacart_orders` ADD COLUMN `invoice_spec_bottom_desc` text NOT NULL;
ALTER TABLE `#__phocacart_order_attributes` ADD COLUMN `option_value` text NOT NULL;
