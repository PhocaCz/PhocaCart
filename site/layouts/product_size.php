...
if ($length || $width || $height ) {
   // echo '<h4 class="ph-header-size">' . Text::_('COM_PHOCACART_HEADER_SIZE') . '</h4>';
...
if ($weight) {
 //   echo '<h4 class="ph-header-size">' . Text::_('COM_PHOCACART_HEADER_WEIGHT') . '</h4>';
...
if ($volume) {
  //  echo '<h4 class="ph-header-size">' . Text::_('COM_PHOCACART_HEADER_VOLUME') . '</h4>';
