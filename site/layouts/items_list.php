...
echo '<div class="'.$s['c']['row-item'].' '.$s['c']["col.xs12.sm12.md12"].' '.$d['lt'].'">';
echo '<div class="ph-item-box '.$d['lt'].'">';

if (!empty($d['labels'])) { echo '<div class="ph-label-box">' . $d['labels'] . '</div>';}

echo '<div class="'.PhocacartRenderFront::completeClass(array($s['c']['thumbnail'], 'ph-thumbnail', 'ph-thumbnail-c', 'ph-item', $t['class_fade_in_action_icons'], $d['lt'], $d['class_additional'])).'">';
echo '<div class="ph-item-content '.$d['lt'].'">';



echo '<div class="'.$s['c']['row'].' '.$s['c']['cat_list'].' ph-item-content-row '.$d['lt'].'">';

// 1/3
echo '<div class="'.$s['c']['row-item'].' ph-category-item-image '.$s['c']['col.xs12.sm2.md2'].' '.$d['lt'].'">';
// :L: IMAGE
echo '<a href="'.$d['link'].'">';
...
// 2/3
echo '<div class="'.$s['c']['row-item'].' ph-category-item-title '.$s['c']['col.xs12.sm5.md5'].' '.$d['lt'].'">';
...
// 3/3
echo '<div class="'.$s['c']['col.xs12.sm5.md5'].' ph-category-item-body '.$d['lt'].'">';
...
echo '</div>';// end category_row_item_gridlist_inner_c3 3/3
