  ...
  <div class="col-lg-12">
	...
	<div class="input-group" id="<?php echo $d['id']; ?>" >
	  ...
	  <span class="input-group-btn">
        <button class="btn btn-default btn-success tip hasTooltip" type="button" onclick="<?php echo $jsSet; ?>" title="<?php echo JText::_('COM_PHOCACART_SEARCH'); ?>" id="<?php echo $d['id'].$d['paramname'].'Btn'; ?>" ><span class="<?php echo PhocacartRenderIcon::getClass('search') ?>"></span></button>
		<button class="btn btn-default btn-danger tip hasTooltip" type="button" onclick="<?php echo $jsClear; ?>" title="<?php echo JText::_('COM_PHOCACART_CLEAR'); ?>" ><span class="<?php echo PhocacartRenderIcon::getClass('clear') ?>" ></span></button>
      </span>
	  <?php if ($d['hide_buttons'] == 1) { ?>
		</div>
	  <?php } ?>
