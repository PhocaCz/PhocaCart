...
//echo '<div class="'.$t['class_fade_in_action_icons'].' ph-thumbnail ph-thumbnail-c ph-item '.$d['lt'].'">';
...
echo '</a>';
echo '</div>';// end category_row_item_gridlist_inner_c1 1/2
...
echo '</div>';// end category_row_item_gridlist_inner_c2 2/2
