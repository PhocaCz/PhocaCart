...
if (isset($x->sku) && $x->sku != '') {
	...
	echo '<div class="ph-sku-txt">'.Text::_('COM_PHOCACART_SKU').':</div>';
...
if (isset($x->ean) && $x->ean != '') {
	...
	echo '<div class="ph-ean-txt">'.Text::_('COM_PHOCACART_EAN').':</div>';
...
if (isset($x->upc) && $x->upc != '') {
	...
	echo '<div class="ph-upc-txt">'.Text::_('COM_PHOCACART_UPC').':</div>';
...
if (isset($x->jan) && $x->jan != '') {
	...
	echo '<div class="ph-jan-txt">'.Text::_('COM_PHOCACART_JAN').':</div>';
...
if (isset($x->isbn) && $x->isbn != '') {
	...
	echo '<div class="ph-isbn-txt">'.Text::_('COM_PHOCACART_ISBN').':</div>';
...
if (isset($x->mpn) && $x->mpn != '') {
	...
	echo '<div class="ph-mpn-txt">'.Text::_('COM_PHOCACART_MPN').':</div>';
...
if (isset($x->serial_number) && $x->serial_number != '') {
	...
	echo '<div class="ph-serial-number-txt">'.Text::_('COM_PHOCACART_SERIAL_NUMBER').':</div>';
