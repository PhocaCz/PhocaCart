...
class PhocacartRouter extends RouterBase
{
	...
	public function parse(&$segments) {
		...
		/*	if (empty($vars) && count($segments) > 1) {
				...
				throw new Exception(Text::_('Nothing found'), 404);
				return false;
			}
		*/
...
/*
		...
		if (!$category)
		{
			throw new Exception(Text::_('COM_PHOCACART_ERROR_PARENT_CATEGORY_NOT_FOUND'), 404);
			return $vars;
		}
